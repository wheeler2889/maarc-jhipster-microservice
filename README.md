...
To build the final jar and optimize the maarc application for production, run:
...
[Service Discovery and Configuration with Consul]: https://www.jhipster.tech/documentation-archive/v8.0.0-beta.3/microservices-architecture/#consul
