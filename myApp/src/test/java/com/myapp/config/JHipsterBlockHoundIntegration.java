...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.myapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.myapp.security.DomainUserDetailsService", "createSpringSecurityUser");
