...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './b.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_B_LIST actions', async () => {
    ...
    it('dispatches FETCH_B actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_B actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_B actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_B actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_B actions', async () => {
      const expectedActions = [
        {
