...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './d.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_D_LIST actions', async () => {
    ...
    it('dispatches FETCH_D actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_D actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_D actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_D actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_D actions', async () => {
      const expectedActions = [
        {
