...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './a.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_A_LIST actions', async () => {
    ...
    it('dispatches FETCH_A actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_A actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_A actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_A actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_A actions', async () => {
      const expectedActions = [
        {
