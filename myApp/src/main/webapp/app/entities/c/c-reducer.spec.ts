...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './c.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_C_LIST actions', async () => {
    ...
    it('dispatches FETCH_C actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_C actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_C actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_C actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_C actions', async () => {
      const expectedActions = [
        {
